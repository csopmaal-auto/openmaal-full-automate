...
writes to the actual "OpenMaal_Full_Feed_Master" table via PostgREST, using the
...
TABLE_NAME = "OpenMaal_Full_Feed_Master"  # case-sensitive - matches the quoted identifier in the table DDL
